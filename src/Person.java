...
public class Person {
    ...
    public static List<Person> fromCsv(String path) throws IOException {
        ...
        String line = reader.readLine();    // niepotrzebna pierwsza linia
        line = reader.readLine();
        while (line != null) {
            Person person = fromCsvLine(line);
            try {
                person.checkAmbiguousPerson(list);
    ...
    public void checkAmbiguousPerson(List<Person> list) throws AmbiguousPersonException {
